...
public class DTOConverter
{
    public static GasSensorStatusResponseDTO convertGasSensorStatusToGasSensorStatusResponseDTO(final GasSensorStatus gas) {
        ...
        return new GasSensorStatusResponseDTO(gas.getId(), gas.getHumidity(), gas.getResistance(), gas.getTemperature(), gas.getVoltage(), gas.getIrradiance(), gas.getTimestamp());
    }
